<template>
  <div>
    <img src="@/resources/png/prisma.png" alt="">
    <UForm
    ...
    >
      <UFormGroup class=" space-y-4">
        <UInput color="primary" variant="outline" v-model="state.base" label="base" placeHolder="base" />
...
async function onSubmit(event: FormSubmitEvent<any>) {
  try {
    ...
    const data = await $fetch('http://localhost:8080/api/prisma',{
      method: 'POST',
